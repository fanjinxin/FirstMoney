/**
 * APT 天赋潜能评估 - 移植自 src/data/apt.ts
 * 60 题，6 维度，每题 5 点量表（1-5）
 */
const APT_DIMENSIONS = [
...
const aptTest = {
  ...
  title: 'APT 天赋潜能评估',
  subtitle: '发现你的优势与潜力',
  description: '本测验从逻辑推理、语言表达、空间想象、创造力、人际交往、抗压韧性六个维度，评估你的天赋倾向与潜能。结果将揭示你的优势维度与发展空间，为职业规划与自我提升提供参考。',
  instructions: [
  ...
  questions: aptQuestions.map(q => ({ id: q.id, text: q.text, dimension: q.dimension, reverse: q.reverse })),
};

module.exports = { aptTest, aptQuestions, APT_DIMENSIONS };
