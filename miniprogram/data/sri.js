/**
 * SRI 性压抑指数测试 - 移植自 src/data/sri.ts
 * 反向计分题目：选「非常符合」表示低压抑，计分时用 (6-原始分) 使高分=高压抑
 */
const sriReverseScoreIds = [
  'sri-1', 'sri-2', 'sri-3', 'sri-4', 'sri-5', 'sri-6', 'sri-7', 'sri-8', 'sri-9', 'sri-10', 'sri-11', 'sri-12',
  'sri-15', 'sri-16', 'sri-17', 'sri-18', 'sri-20', 'sri-21', 'sri-23', 'sri-24',
  'sri-29', 'sri-30', 'sri-33', 'sri-35', 'sri-36',
  'sri-40', 'sri-41', 'sri-42', 'sri-44', 'sri-47', 'sri-48',
];
...
const sriTest = {
  ...
  description: '评估个体在性与亲密议题上压抑自身感受与欲望的程度，涵盖欲望表达、观念冲突、情绪紧张、行为抑制四个维度。结果仅供自我觉察与沟通参考。',
  instructions: [
  ...
  dimensions: [
    { id: 'expression', name: '欲望表达', description: '对性需求与亲密偏好的表达能力与开放度', lowHint: '在安全情境下能较自然表达需求与偏好，沟通顺畅。', midHint: '表达时有保留或选择性开放，可尝试逐步增加安全表达。', highHint: '表达需求时明显受限或回避，建议从可接纳的小步表达开始。' },
    { id: 'conflict', name: '观念冲突', description: '内心观念、道德感与实际欲望之间的冲突程度', lowHint: '观念与欲望较为一致，内在冲突较少。', midHint: '偶有「应该」与「想要」的冲突，可尝试自我理解与整合。', highHint: '观念与欲望冲突明显，易自责或压抑，建议在安全前提下探讨价值观。' },
    { id: 'anxiety', name: '情绪紧张', description: '在性与亲密话题上的焦虑、羞耻与紧张感', lowHint: '谈及相关话题时紧张感较少，羞耻感较低。', midHint: '部分情境下会紧张或羞耻，可逐步在安全关系中练习。', highHint: '紧张、羞耻或焦虑感明显，建议从情绪觉察与安全对话开始。' },
    { id: 'inhibition', name: '行为抑制', description: '对亲密行为与性表达的抑制与回避程度', lowHint: '在自愿与安全前提下，行为与意愿较为一致。', midHint: '有时会抑制或回避某些亲密表达，可关注舒适区与边界。', highHint: '明显抑制或回避亲密行为，建议结合伴侣沟通与自我接纳逐步调整。' },
  ],
  questions: [
...
module.exports = { sriTest, sriReverseScoreIds };
