/**
 * YBT 病娇测试 - 移植自 src/data/ybt.ts
 * 40 题，4 维度，5 点量表
 */
const YBT_DIMENSIONS = [
...
const ybtTest = {
  ...
  instructions: ['请根据真实感受作答，每题五选一', '本测验仅供娱乐与自我觉察，不构成诊断'],
  options: [
    { value: 1, label: '完全不符合' },
    { value: 2, label: '不太符合' },
    { value: 3, label: '一般' },
  ...
  questions: ybtQuestions.map(q => ({ id: q.id, text: q.text, dimension: q.dimension, reverse: q.reverse })),
};

module.exports = { ybtTest, ybtQuestions, YBT_DIMENSIONS };
