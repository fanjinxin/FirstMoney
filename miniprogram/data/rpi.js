/* RPI 恋爱占有欲指数测试 - 40题双视角 */
const rpiTest = {
  id: 'rpi',
  title: 'RPI 恋爱占有欲指数测试',
  subtitle: '40 题双视角完整版',
  description: '评估亲密关系中的占有欲程度，含控制欲望、嫉妒强度、情感依赖、关系不安全感四个维度。',
  instructions: [
    '选择视角后作答，可切换视角分别完成',
    '以最近三个月内的真实体验为准',
    '本量表仅用于关系沟通与自我觉察参考'
  ...
  options: [
    { label: '非常不符合', value: 1 }, { label: '比较不符合', value: 2 }, { label: '一般', value: 3 },
    { label: '比较符合', value: 4 }, { label: '非常符合', value: 5 }
  ],
  dimensions: [
    { id: 'control', name: '控制欲望', lowHint: '控制倾向较低，关系边界较健康。', midHint: '对关系有一定控制需求，建议与伴侣讨论边界与舒适区。', highHint: '控制倾向较强，建议觉察不安全感来源，练习信任与开放沟通。' },
    { id: 'jealousy', name: '嫉妒强度', lowHint: '嫉妒反应较少，情绪较平稳。', midHint: '在部分情境下会敏感，适度澄清与表达有助于关系。', highHint: '嫉妒反应较明显，建议结合安全感与自我认同一起探讨。' },
    { id: 'dependency', name: '情感依赖', lowHint: '依恋需求适中，独立性较好。', midHint: '依恋需求有所增加，可尝试平衡亲密与个人空间。', highHint: '情感依赖较强，建议逐步发展自我关怀与稳定互动节奏。' },
    { id: 'security', name: '关系不安全感', lowHint: '关系安全感较稳定，信任感较好。', midHint: '安全感时有波动，建议加强正向沟通与约定。', highHint: '不安全感较明显，建议建立更清晰的约定与支持方式。' }
  ],
  questions: [
