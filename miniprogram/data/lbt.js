...
const lbtTest = {
  ...
  dimensions: LBT_DIMENSIONS,
  questions: lbtQuestions.map(q => ({ id: String(q.id), text: q.text, dimension: 'general' }))
};

module.exports = { lbtTest, lbtQuestions, LBT_DIMENSIONS };
