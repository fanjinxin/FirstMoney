/**
 * RVT 恋爱观测试 - 移植自 src/data/rvt.ts
 * 36 题，6 维度，5 点量表
 */
const RVT_DIMENSIONS = [
...
const rvtTest = {
  ...
  questions: rvtQuestions.map(q => ({ id: q.id, text: q.text, dimension: q.dimension, reverse: q.reverse })),
};

module.exports = { rvtTest, rvtQuestions, RVT_DIMENSIONS };
