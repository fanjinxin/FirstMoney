/**
 * YBT 病娇测试解读 - 移植自 src/data/ybt_insights.ts（完整版）
 */
const YBT_LEVEL_LABELS = {
  low: '偏低',
  moderate: '适中',
  high: '偏高',
};
...
const YBT_DIMENSION_INSIGHTS = {
  possess: '占有欲反映你希望独享伴侣的倾向，包括对伴侣社交、注意力的敏感度。适度的占有是爱的表现；过高可能让伴侣感到被束缚，需注意尊重边界与信任建立。',
  control: '控制欲反映你想了解、参与甚至主导伴侣生活的倾向。适度关心能增进亲密；过高可能侵犯对方隐私与自由，引发反感。学会区分「关心」与「控制」很重要。',
  depend: '依赖度反映你对伴侣的情感依恋程度。适度依赖有助于亲密感与安全感；过高可能导致失去自我、过度焦虑、害怕被抛弃。保持一定的情绪独立有利于关系稳定。',
  extreme: '极端倾向反映在关系受挫时出现激烈想法或行为的可能性。低分者更能理性应对冲突；高分者需关注情绪调节。若极端想法反复出现，建议寻求专业心理咨询。',
};

const YBT_RELATIONSHIP_TIPS = {
  gentle: [
    '保持信任与开放沟通',
    '适度表达自己的需求，不必过于压抑',
    '若伴侣占有欲较强，可温和设定边界',
