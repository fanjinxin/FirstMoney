 ...
 */
const RVT_LEVEL_LABELS = { low: '偏低', moderate: '适中', high: '偏高' };
...
const RVT_DIMENSION_BY_LEVEL = {
  eros: { low: '浪漫情欲倾向较低，更注重友谊、现实或陪伴，不太相信一见钟情。', moderate: '浪漫情欲倾向适中，既能享受激情，也关注其他维度。', high: '浪漫情欲倾向较高，重视外表吸引与强烈情感体验。' },
  ludus: { low: '游戏倾向较低，倾向于认真投入关系，追求长久承诺。', moderate: '游戏倾向适中，能在轻松与投入之间平衡。', high: '游戏倾向较高，倾向于避免深度投入，保持自由。' },
  storge: { low: '友谊倾向较低，更相信一见钟情或激情先行。', moderate: '友谊倾向适中，认同日久生情与陪伴的重要性。', high: '友谊倾向较高，追求从朋友发展为伴侣的稳定关系。' },
  mania: { low: '占有倾向较低，能保持情绪独立与边界。', moderate: '占有倾向适中，会有依赖与在意，但能把握尺度。', high: '占有倾向较高，容易依赖、占有，情绪强烈且易焦虑。' },
  pragma: { low: '现实倾向较低，更凭感觉与情感做选择。', moderate: '现实倾向适中，会理性评估，但不完全忽略感觉。', high: '现实倾向较高，重视条件、合适与长远规划。' },
  agape: { low: '奉献倾向较低，更注重平等付出与自身需求。', moderate: '奉献倾向适中，愿意付出，也会关注自己的需求。', high: '奉献倾向较高，倾向于无条件付出、优先满足伴侣。' },
};
...
const RVT_RELATIONSHIP_TIPS = {
  eros: ['选择重视吸引力、善于表达热情的伴侣', '接受激情随时间消退，培养默契与陪伴', '用共同的浪漫回忆与日常相处支撑长期关系'],
  ludus: ['若希望稳定，可尝试适度投入与承诺', '与伴侣坦诚沟通彼此对关系的期待', '在自由与联结之间寻找适合自己的平衡'],
  storge: ['选择能聊得来、处得来、共度日常的伴侣', '适度营造浪漫与惊喜，保持关系新鲜感', '与伴侣一起设定共同目标，共同成长'],
  mania: ['练习情绪独立，不过度依赖伴侣的态度', '给伴侣一定空间，用沟通替代猜忌', '若焦虑持续，建议寻求专业心理咨询'],
  pragma: ['与目标一致、愿意共同经营的伴侣更匹配', '在理性评估的同时，关注情感联结', '适时用浪漫表达增进亲密感'],
  agape: ['在付出的同时，关注自己的需求与边界', '与伴侣建立平等的付出与接受', '健康的爱是双向的，不必一味牺牲'],
  balanced: ['根据关系阶段与伴侣特点灵活表达', '保持觉察，在六维之间寻找平衡', '定期与伴侣沟通彼此对恋爱的期待'],
};

function getRVTProfileKey(primary, secondary) {
  const gap = primary.percent - (secondary ? secondary.percent : 0);
  if (gap >= 15) return primary.id;
  return 'balanced';
}

const RVT_SUBJECT_SHORT = { eros: '浪漫', ludus: '游戏', storge: '友谊', mania: '占有', pragma: '现实', agape: '奉献' };
const RVT_DIMENSION_ICONS = { eros: '/assets/icons/sparkles.svg', ludus: '/assets/icons/compass.svg', storge: '/assets/users-icon.svg', mania: '/assets/icons/heart.svg', pragma: '/assets/icons/chart-bar.svg', agape: '/assets/icons/flower.svg' };
