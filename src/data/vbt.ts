/**
 * VBT 你有多容易被人欺负测试
 * 共 40 题，4 维度：边界感、 assertive、敏感度、应对方式
 * 5 点量表
 */

export const VBT_TEST_ID = 'vbt'

export const VBT_DIMENSIONS = [
...
export type VBTDimensionId = (typeof VBT_DIMENSIONS)[number]['id']

export interface VBTQuestion {
  id: number
  text: string
  dimension: VBTDimensionId
  reverse: boolean
}

export const vbtQuestions: VBTQuestion[] = [
  // 1-10 边界感 (高分=边界清晰，不易被欺负)
